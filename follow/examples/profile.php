            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 ml-auto mr-auto text-center">
                        ...
                        <br/>
                        <input type="submit" value="Settings" class="btn btn-outline-default btn-round" href="edituser.php"></input>
                    </div>
                </div>
                <br/>
                ...
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active" id="follows" role="tabpanel">
											...
											<?php $sql = "SELECT * FROM fm_follows, fm_users WHERE fm_follows.userid = $userid AND fm_follows.followid = fm_users.followid"; ?>
